...
## Divine Project Context

Read `/Users/rabble/code/divine/divine-context/AGENT_CONTEXT.md` before making changes. Divine is a human-made, decentralized short-form video network built on Nostr. Preserve user ownership, creative weirdness, direct human voice, and operational reliability.

Treat frustration as frustration with the problem. Respond with calm technical clarity, current-code evidence, root-cause fixes, focused tests, and small reviewable changes. Never invent protocol behavior, truncate Nostr IDs, expose secrets, or leave work unfinished.
